 ...
 */
final class Version20231030102853 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE shipping_item (id INT AUTO_INCREMENT NOT NULL, shipping_id INT NOT NULL, product_id INT DEFAULT NULL, INDEX IDX_8EA7B31C4887F3F8 (shipping_id), INDEX IDX_8EA7B31C4584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
